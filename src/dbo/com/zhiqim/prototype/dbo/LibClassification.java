...
/**
 * 组件分类表 对应表《LIB_CLASSIFICATION》
 */
@AnAlias("LibClassification")
@AnNew
@AnTable(table="LIB_CLASSIFICATION", key="ID,PID", type="InnoDB")
public class LibClassification implements Serializable
{
    ...
    @AnTableField(column="CLS_STYLE", type="byte", notNull=true)    private int clsStyle;    //3.分类风格：1：后台
    ...
    @AnTableField(column="CLS_KEYS", type="string,500", notNull=false)    private String clsKeys;    //7.分类关键词
    ...
    public int getClsStyle()
    {
        return clsStyle;
    }

    public void setClsStyle(int clsStyle)
    {
