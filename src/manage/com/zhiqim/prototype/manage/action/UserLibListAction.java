 ...
 */
public class UserLibListAction extends StdSwitchAction
{
    ...
    protected void list(HttpRequest request) throws Exception
    {
        ...
        PageResult<UserLib> pageResult = ORM.get(ZTable.class).page(UserLib.class, page, 15, sel);
    ...
    protected void delete(HttpRequest request) throws Exception
    {
        ...
        ORM.get(ZTable.class).delete(UserLib.class, sel);
    }
    
    /**
     * 
     */
    public UserLibListAction()
    {
